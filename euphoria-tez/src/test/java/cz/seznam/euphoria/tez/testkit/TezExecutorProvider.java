 ...
 */
package cz.seznam.euphoria.tez.testkit;
...
import cz.seznam.euphoria.tez.TezExecutor;


public interface TezExecutorProvider extends ExecutorProvider {

  default ExecutorEnvironment newExecutorEnvironment() throws Exception {

    final Executor executor = new TezExecutor();
